...
| **L3 — Autonomous external actions** | **NO-GO** | Requires L2 controls, credential closure, proven end-to-end control and an owner-approved external-action policy. | B-1, B-2, plus all of L2. |
